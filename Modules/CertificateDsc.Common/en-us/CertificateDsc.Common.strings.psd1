ConvertFrom-StringData @'
    ...
    TemplateNameResolutionError         = Failed to resolve the template name from Active Directory certificate templates.
    TemplateNameNotFound                = No template name found.
