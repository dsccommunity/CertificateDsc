...
InModuleScope $script:subModuleName {
    Describe 'CertificateDsc.Common\Test-DscParameterState' -Tag 'Test-DscParameterState' {
        ...
        Context 'When passing an CimInstance as DesiredValue and ValuesToCheck is $null' {
            It 'Should throw the correct error' {
                ...
                {
                    Test-DscParameterState @testParameters
                } | Should -Throw $mockCorrectErrorMessage
            }
        }
    ...
    Describe 'CertificateDsc.Common\Get-LocalizedData' -Tag 'Get-LocalizedData' {
        $mockTestPath = {
    ...
    Describe 'CertificateDsc.Common\New-InvalidResultException' -Tag 'New-InvalidResultException' {
    ...
    Describe 'CertificateDsc.Common\New-ObjectNotFoundException' -Tag 'New-ObjectNotFoundException' {
        Context 'When calling with Message parameter only' {
            It 'Should throw the correct error' {
                $mockErrorMessage = 'Mocked error'
    ...
    Describe 'CertificateDsc.Common\New-InvalidOperationException' -Tag 'New-InvalidOperationException' {
        Context 'When calling with Message parameter only' {
            It 'Should throw the correct error' {
                $mockErrorMessage = 'Mocked error'
    ...
    Describe 'CertificateDsc.Common\New-NotImplementedException' -Tag 'New-NotImplementedException' {
    ...
    Describe 'CertificateDsc.Common\New-InvalidArgumentException' -Tag 'New-InvalidArgumentException' {
